    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="outline" size="icon" className={cn("rounded-full w-10 h-10 group overflow-hidden justify-start px-3 duration-300", theme !== "system" ? "hover:w-32" : "hover:w-[6.5rem]")}>
